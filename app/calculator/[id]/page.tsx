        ...
        <span className="text-xl w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0 text-base"
          ...
          {calc.icon}
                ...
                <div className="min-w-0">
                    ...
                    <div
                        className="text-xs text-[var(--text-muted)] mt-0.5 leading-snug line-clamp-1">{calc.description}</div>
                </div>
            </div>
        </button>
    );
            ...
            <aside
                ...
                <Link href="/" className="flex items-center gap-3 px-5 py-4 border-b"
                    ...
                    <div>
                        <div className="font-bold text-base leading-none"
                             style={{fontFamily: "var(--font-outfit)"}}>Calcosmos
                        </div>
                        <div className="text-xs mt-0.5"
                             style={{color: "var(--text-muted)"}}>{CALCULATORS.length} calculators
                        </div>
                    </div>
                    <button
                ...
                <div className="px-4 pt-3 pb-2">
                    <div className="text-xs font-semibold tracking-widest uppercase mb-2"
                         style={{color: "var(--text-muted)"}}>Category
                    </div>
